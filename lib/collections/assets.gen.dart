...
class $AssetsBrandingGen {
  ...
  /// File path: assets/branding/tonic-logo-light.png
  AssetGenImage get tonicLogoLight =>
      const AssetGenImage('assets/branding/tonic-logo-light.png');

  /// File path: assets/branding/tonic-logo.ico
  String get tonicLogoIco => 'assets/branding/tonic-logo.ico';

  /// File path: assets/branding/tonic-logo.png
  AssetGenImage get tonicLogoPng =>
      const AssetGenImage('assets/branding/tonic-logo.png');

  /// List of all assets
  List<dynamic> get values =>
      [tonicLogoLight, tonicLogoIco, tonicLogoPng];
}
